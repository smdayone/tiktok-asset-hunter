#!/usr/bin/env python3
"""
BATCH VIDEO DOWNLOADER — TikTok & Instagram
────────────────────────────────────────────────────────────────────────
Downloads TikTok and Instagram videos from CSV/TXT files generated by
tiktok_url_collector.js (supports TikTok search, TikTok profiles, Instagram profiles)

REQUIREMENTS:
    pip install yt-dlp

BASIC USAGE:
    python scripts/tiktok_batch_download.py --links links/queue/tiktok_search_earbuds_20260419_1430.csv --out "D:\\Products Reels\\wireless_earbuds"

MULTI-FILE USAGE:
    python scripts/tiktok_batch_download.py --links links/queue/file1.csv links/queue/file2.csv --out "D:\\Products Reels\\earbuds"

USAGE WITH LIMIT:
    python scripts/tiktok_batch_download.py --links links/queue/file.csv --out "D:\\Products Reels\\earbuds" --max 20
...
def _is_valid_url(u: str) -> bool:
    ...
    if "tiktok.com" in u and "/video/" in u:
        return True
    if "instagram.com" in u and ("/p/" in u or "/reel/" in u):
        return True
    return False
